...
# 6. ui/repo-selector.tsx
repo_selector_tsx = r"""import React, { useState, useEffect } from 'react';
...
with open('jupyterlab-wiki3-publish/src/ui/repo-selector.tsx', 'w') as f:
    f.write(repo_selector_tsx)

print("✓ Created repo-selector.tsx")
