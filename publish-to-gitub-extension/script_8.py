...
# 5. ui/token-dialog.tsx
token_dialog_tsx = r"""import React, { useState } from 'react';
...
with open('jupyterlab-wiki3-publish/src/ui/token-dialog.tsx', 'w') as f:
    f.write(token_dialog_tsx)

print("✓ Created token-dialog.tsx")
