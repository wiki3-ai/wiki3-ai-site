...
# 2. github-auth.ts
github_auth_ts = """import { GitHubUser } from './types';
...
with open('jupyterlab-wiki3-publish/src/github-auth.ts', 'w') as f:
    f.write(github_auth_ts)

print("✓ Created github-auth.ts")
